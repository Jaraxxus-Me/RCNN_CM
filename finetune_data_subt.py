...
class MetaData(data.Dataset):
    ...
    def get_prndata(self):
        ...
        for img_id in self.ids:
            ...
            img_path = os.path.join(self.root, "JPEGImages", data["filename"])
            ...
            if proper:
                self.shot_path.write(str(img_id)+'\n')
...
class SubTData(data.Dataset):
    ...
    def __init__(self, root, allclass, transforms, txt_name: str):
        ...
        print("use Subt val.txt, total images: {:d}".format(len(self.data["path"])))
